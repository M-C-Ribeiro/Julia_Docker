...
const ALL = "ALL"
const db = SQLite.DB(joinpath("data","vendas.sqlite")) # conexao com banco

# exibir colunas abaixo dos graficos
...
@reactive mutable struct Faturamento :: ReactiveModel
...
Stipple.js_mounted(::Faturamento) = watchplots()
  
function handlers(model<:Faturamento)
